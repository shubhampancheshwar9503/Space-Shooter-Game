...
function fireLaser() {
  ...
  let laserSFX = new Audio('audio_laser-sfx.m4a')
  laserSFX.play()
  moveLaser(laser)
}
  ...
  let laserInterval = setInterval(() => {
    ...
    monsters.forEach(monster => {
      if (checkLaserCollision(laser, monster)) {
        let explosion = new Audio('audio_explosion.m4a')
        explosion.play()
...
function gameOver() {
  ...
  justice.pause()
  let gameOverSfx = new Audio('audio_game-over.m4a')
  gameOverSfx.play()
...
function playGame() {
  ...
  justice = new Audio("audio_Justice-One-Minute-To-Midnight.m4a")
  justice.play()
